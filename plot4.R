...
par(mfrow=c(2,2))
with(dataset,{
      plot(x=DateTime, y=Global_active_power, type="l", main=NULL, ylab = "Global Active Power", xlab="")
      plot(x=DateTime, y=Voltage, type="l", main=NULL, ylab = "Voltage", xlab="datetime")
      plot(x=DateTime, y=Sub_metering_1, type="l", main=NULL, ylab = "Energy sub metering", xlab="")
      lines(x=DateTime, y=Sub_metering_2, col="red")
      lines(x=DateTime, y=Sub_metering_3, col="blue")
      legend("topright", cex=0.9, bty="n", lty=1, col=c("black","red","blue"), legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))
      plot(x=DateTime, y=Global_reactive_power, type="l", main=NULL, ylab = "Global_reactive_power", xlab="datetime")
})
dev.off()